...
IO_SUB_A_PKL = "/tmp/io_sub.pkl"
IO_SUB_B_PKL = "/tmp/io_sub_.pkl"
...
io_subalt = io_sub.copy()
io_subalt_ = io_sub_.copy()

edge1 = [(src, dst, key) for src, dst, key in io_subalt.edges if key == 583015][0]
edge2 = [(src, dst, key) for src, dst, key in io_subalt.edges if key == 583016][0]

edge1_ = [(src, dst, key) for src, dst, key in io_subalt_.edges if key == 583015][0]
edge2_ = [(src, dst, key) for src, dst, key in io_subalt_.edges if key == 583016][0]
...
io_subalt.edges[edge1]["properties"]["op_idx"] = 0
io_subalt.edges[edge2]["properties"]["op_idx"] = 1
io_subalt.edges[edge1]["properties"]["out_idx"] = 0
io_subalt.edges[edge2]["properties"]["out_idx"] = 1

io_subalt_.edges[edge1_]["properties"]["op_idx"] = 1
io_subalt_.edges[edge2_]["properties"]["op_idx"] = 0
# io_subalt_.edges[edge1_]["properties"]["out_idx"] = 1
# io_subalt_.edges[edge2_]["properties"]["out_idx"] = 0
io_subalt_.edges[edge1_]["properties"]["out_idx"] = 0
io_subalt_.edges[edge2_]["properties"]["out_idx"] = 1

print("io_sub", io_sub)
print("io_sub_", io_sub_)
print("io_subalt", io_subalt)
print("io_subalt_", io_subalt_)
